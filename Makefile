...
build_mailer:
	...
	cd mail && env GOOS=linux CGO_ENABLED=0 go build -o ${MAILER_BINARY} ./cmd/api
	@echo "Done!"
...
build_front_linux:
	...
	cd front-end && env GOOS=linux CGO_ENABLED=0 go build -o ${FRONTEND_BINARY} ./cmd/web
	@echo "Done!"
...
## restart: restarts the front end
restart: stop start
